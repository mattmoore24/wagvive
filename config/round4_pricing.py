...
MANIFEST = {
 'sneaker':  {'title': 'Wagvive Sneaker Chew Buddy', 'opt': 'Colour', 'price': {'*': '16.99'},
 ...
 'chicken':  {'title': 'Wagvive Screaming Chicken', 'opt': 'Colour', 'price': {'*': '24.99'},
    'vars': [('CJST258510901AZ', 'Green'), ('CJST258510902BY', 'Orange'), ('CJST258510903CX', 'Black')]},
 'towel':    {'title': 'Wagvive Quick-Dry Bath Robe', 'opt': ('Colour', 'Size'),
 ...
 'lednail':  {'title': 'Wagvive LED Nail Clippers', 'opt': 'Colour', 'price': {'*': '27.99'},
 ...
 'pawcup':   {'title': 'Wagvive Paw Washing Cup', 'opt': ('Colour', 'Size'),
 ...
 'wblanket': {'title': 'Wagvive Waterproof Snuggle Blanket', 'opt': ('Colour', 'Size'),
 ...
 'thunder':  {'title': 'Wagvive Calming Thunder Wrap', 'opt': 'Colour', 'price': {'*': '36.99'},
 ...
 'fleece':   {'title': 'Wagvive Paw Print Fleece Blanket', 'opt': ('Colour', 'Size'),
